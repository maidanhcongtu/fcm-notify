...
self.addEventListener('notificationclick', function(event) {
   if (event.action === 'like') {
       ...
       self.clients.openWindow("https://example.com/fish_photos/like/" + photoId);
   }
   else if (event.action === 'unlike') {
       // Unlike button was clicked

       const photoId = event.notification.data.photoId;
       self.clients.openWindow("https://example.com/fish_photos/unlike/" + photoId);
   }
